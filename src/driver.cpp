...
public:
	...
	DecaMoveVirtualTrackerDriver()
	{
		...
		m_sSerialNumber = "DecaMoveTrack_" + rand();
	...
	virtual EVRInitError Activate( vr::TrackedDeviceIndex_t unObjectId )
	{
		...
		if (deca_move == nullptr)
			auto status = decaMoveInit({}, callbacks, &deca_move);
	...
	virtual DriverPose_t GetPose()
	{
		...
		Vector3 offset_local_tracker = Vector3(0.0, -0.73, 0);

		Vector3 local_rot_euler = Vector3(0.0, 0.0, 0.0);
